...
/**
 * Componente Hero - Flat Design
 *
 * Sección principal con diseño flat: colores sólidos, formas geométricas simples.
 */

export default function Hero() {
  return (
    <section className="hero min-h-screen relative overflow-hidden pt-20 bg-base-100">
      {/* Background flat - sin gradientes */}
      <div className="absolute inset-0 grid-pattern-flat opacity-40" />

      {/* Formas geométricas flat en lugar de blobs */}
      ...
      <div className="hero-content text-center lg:text-left relative z-10">
        <div className="max-w-4xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-12 animate-fade-in-up animate-fill-both animate-delay-300">
            <a href="/pricing" className="btn btn-primary btn-lg border-2">
              Ver planes
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
              </svg>
            </a>
            <a href="#features" className="btn btn-outline btn-lg border-2">
              Conoce más
