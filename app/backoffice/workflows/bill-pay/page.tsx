...
export default async function BillPayPage({ searchParams }: { searchParams?: { companyId?: string } }) {
    ...
    return (
      <div className="min-h-screen bg-base-200 text-base-content flex items-center justify-center">
        <div className="text-center space-y-3">
          ...
          <p className="text-base-content/70">Inicia sesión para ver Bill Pay.</p>
        </div>
      </div>
    )
  }
    ...
    return (
      <div className="min-h-screen bg-base-200 text-base-content flex items-center justify-center">
        <div className="text-center space-y-3">
          ...
          <p className="text-base-content/70">Completa el onboarding para gestionar Bill Pay.</p>
        </div>
      </div>
    )
  }
  ...
  return (
    ...
    >
      <CardPanel title="Bill Pay" subtitle="Sin datos">
        <p className="text-sm text-base-content/70">Aún no hay facturas en Bill Pay.</p>
      </CardPanel>
    </BackofficeShell>
  )
}
