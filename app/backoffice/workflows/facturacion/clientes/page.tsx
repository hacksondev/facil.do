...
export default async function ClientesPage({ searchParams }: { searchParams?: { companyId?: string } }) {
    ...
    return (
      <div className="min-h-screen bg-base-200 text-base-content flex items-center justify-center">
        <div className="text-center space-y-3">
          ...
          <p className="text-base-content/70">Inicia sesión para ver clientes.</p>
        </div>
      </div>
    )
  }
  ...
  return (
    ...
    >
      <CardPanel title="Clientes" subtitle="Sin datos">
        <p className="text-sm text-base-content/70">Aún no hay clientes cargados.</p>
      </CardPanel>
    </BackofficeShell>
  )
}
