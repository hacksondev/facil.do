...
export default async function FacturacionPage({
  ...
  return (
    <BackofficeShell
      ...
      activePath="/backoffice/workflows/facturacion"
      title="Facturación"
      subtitle="Workflows"
      actionLabel="Nueva factura"
    >
      <CardPanel title="Estado de facturación" subtitle="Mock">
        <div className="rounded-xl border border-base-300 bg-base-100 p-4 text-sm text-base-content/70">
          Resumen de facturas emitidas, pagadas y vencidas. Sin datos mock aún.
        </div>
      </CardPanel>
    </BackofficeShell>
  )
