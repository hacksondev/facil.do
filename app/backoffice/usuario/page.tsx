...
export default async function UsuarioPage({ searchParams }: { searchParams?: { companyId?: string } }) {
  ...
  return (
    ...
    >
      <CardPanel title="Perfil de usuario" subtitle="Mock">
        <div className="rounded-xl border border-base-300 bg-base-100 p-4 text-sm text-base-content/70 space-y-2">
          <p>Nombre, email corporativo, rol y MFA. (Mock, sin datos aún)</p>
        </div>
      </CardPanel>
    </BackofficeShell>
  )
