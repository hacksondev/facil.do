...
export default async function CapitalPage({ searchParams }: { searchParams?: { companyId?: string } }) {
    ...
    return (
      <div className="min-h-screen bg-base-200 text-base-content flex items-center justify-center">
        <div className="text-center space-y-3">
          ...
          <p className="text-base-content/70">Inicia sesión para ver capital.</p>
        </div>
      </div>
    )
  }
    ...
    return (
      <div className="min-h-screen bg-base-200 text-base-content flex items-center justify-center">
        <div className="text-center space-y-3">
          ...
          <p className="text-base-content/70">Completa el onboarding para gestionar capital.</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <BackofficeShell
      ...
      actionLabel="Solicitar línea"
    >
      <CardPanel title="Capital" subtitle="Próximamente">
        <p className="text-sm text-base-content/70">
          Conecta tu línea de crédito y estados financieros para ver disponibilidad. Aún no hay datos.
        </p>
      </CardPanel>
    </BackofficeShell>
  )
