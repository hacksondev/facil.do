...
export default async function DocumentosPage({ searchParams }: { searchParams?: { companyId?: string } }) {
    ...
    return (
      <div className="min-h-screen bg-base-200 text-base-content flex items-center justify-center">
        <div className="text-center space-y-3">
          ...
          <p className="text-base-content/70">Inicia sesión para ver documentos.</p>
        </div>
      </div>
    )
  }
    ...
    return (
      <div className="min-h-screen bg-base-200 text-base-content flex items-center justify-center">
        <div className="text-center space-y-3">
          ...
          <p className="text-base-content/70">Completa el onboarding para ver documentos.</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <BackofficeShell
      ...
      actionLabel="Subir"
    >
      <CardPanel title="Documentos" subtitle="Sin datos">
        <p className="text-sm text-base-content/70">Aún no hay documentos cargados en esta vista.</p>
      </CardPanel>
    </BackofficeShell>
  )
}
