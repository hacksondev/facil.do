...
export default async function OnboardingAdminPage({ searchParams }: { searchParams?: { companyId?: string } }) {
    ...
    return (
      <div className="min-h-screen bg-base-200 text-base-content flex items-center justify-center">
        <div className="text-center space-y-3">
          ...
          <p className="text-base-content/70">Inicia sesión para ver onboarding.</p>
        </div>
      </div>
    )
  }
    ...
    return (
      <div className="min-h-screen bg-base-200 text-base-content flex items-center justify-center">
        <div className="text-center space-y-3">
          ...
          <p className="text-base-content/70">Completa el onboarding para ver casos.</p>
        </div>
      </div>
    )
  }
  ...
  return (
    ...
    >
      <CardPanel title="Casos de onboarding" subtitle="Sin datos">
        <p className="text-sm text-base-content/70">Aún no hay casos listados en esta vista.</p>
      </CardPanel>
    </BackofficeShell>
  )
}
