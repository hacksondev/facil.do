...
export default async function ReferidosPage({ searchParams }: { searchParams?: { companyId?: string } }) {
    ...
    return (
      <div className="min-h-screen bg-base-200 text-base-content flex items-center justify-center">
        <div className="text-center space-y-3">
          ...
          <p className="text-base-content/70">Inicia sesión para ver referidos.</p>
        </div>
      </div>
    )
  }
    ...
    return (
      <div className="min-h-screen bg-base-200 text-base-content flex items-center justify-center">
        <div className="text-center space-y-3">
          ...
          <p className="text-base-content/70">Completa el onboarding para gestionar referidos.</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <BackofficeShell
      ...
      actionLabel="Invitar"
    >
      <CardPanel title="Referidos" subtitle="Sin datos">
        <p className="text-sm text-base-content/70">Aún no hay referidos registrados.</p>
      </CardPanel>
    </BackofficeShell>
  )
}
